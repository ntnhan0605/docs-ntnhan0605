...
// Observable.prototype.concatAll = function(...listObs$) {
//   function concatAllWaitToRun(onNewNextFn) {
//     let copyListObs$ = listObs$.slice()
//     let currentSub = null

//     function handleEachObservable() {
//       if (copyListObs$.length === 0) {
//         return
//       }
      
//       let nextObs$ = copyListObs$.shift()

//       currentSub = nextObs$.forEach((data) => {
//         onNewNextFn(data)
//       })
//     }

//     handleEachObservable()
//   }

//   return new Observable(concatAllWaitToRun)
// }