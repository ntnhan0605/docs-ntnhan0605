<template>
  <section class="relative flex justify-start padding-left-lg padding-bottom-xxxl items-end" style="max-width: 890px; height: 600px; margin: 0 auto;">
    ...
    <div class="relative" style="width: 320px;max-height: 475px; background: white;">
      ...
      <div v-if="!isShowThankYou" class="relative" style="max-height: 475px; overflow: auto;">
        <div style="min-height: 118px">
          <ImageBlock :placeholder-size="imageSize.DesktopSlider" :block="imageBlocks.imageMobile" ref="editblock-static-image-desktop"></ImageBlock>
        </div>
        <section :style=" { background: `url(${imageBlocks.imageOverlayDesktop.data.value}) no-repeat`, backgroundSize: 'cover'} ">
