<template>
  <section class="relative flex justify-end padding-right-xxxl items-center" style="max-width: 890px; height: 600px; margin: 0 auto;">
    ...
    <div class="relative" style="width: 320px;max-height: 475px; background: white;">
      ...
      <div v-if="!isShowThankYou" class="relative" style="max-height: 475px; overflow: auto;">
        <div style="min-height: 118px">
          <ImageBlock :placeholder-size="imageSize.DesktopSidebar" :block="imageBlocks.imageMobile" ref="editblock-static-image-desktop"></ImageBlock>
        </div>
