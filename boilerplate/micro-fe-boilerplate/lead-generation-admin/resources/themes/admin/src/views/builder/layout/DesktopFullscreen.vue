<template>
  <section class="relative flex justify-center items-center" style="max-width: 890px; height: 600px; margin: 0 auto;">
    ...
    <div class="builder-fullscreen-block">
      <img src="/img/newbuilder/close_btn.svg" width="35" height="35" class="absolute" style="top: 15px;right:15px;z-index: 10; " alt />
      <ImageBlock :placeholder-size="imageSize.DesktopFullscreen" :block="imageBlocks.imageBackground" />
    </div>
    <div class="relative sd" style="width: 320px;max-height: 475px; background: white; z-index: 2;">
