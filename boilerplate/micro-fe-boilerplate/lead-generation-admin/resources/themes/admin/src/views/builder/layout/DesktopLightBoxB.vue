      ...
      <div v-if="!isShowThankYou" style="max-height: 400px; overflow: auto;">
        <div class="grid gap-0">
          <div class="col-6 padding-0">
            <ImageBlock :placeholder-size="imageSize.DesktopLightBoxB" :placeholder-style="`top:calc(50% + 35px); left:50%; transform: translate(-50%,-50%)`" :block="imageBlocks.imageDesktop" ref="editblock-static-image-desktop"></ImageBlock>
          </div>
          <div id="lightbox-b-blocks" class="col-6 padding-sm" :style=" { background: `url(${imageBlocks.imageOverlayDesktop.data.value}) no-repeat`, 'background-size': 'cover'}">
            <div>
