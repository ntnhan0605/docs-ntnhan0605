...
var LEAD_CURRENT_URL = 'https://' + location.hostname + location.pathname + location.search;
...
function LEAD_RESET_VAR() {
  ...
  LEAD_CURRENT_URL = 'https://' + location.hostname + location.pathname + location.search;
  // For config axios
  //  LEAD_AXIOS_CONFIG = {};
...
function LOAD_LEAD_SCRIPT() {
  ...
  script.onload = function() {
    ...
    function leadShowPopup(campaignShow) {
      ...
      jQuery('body').addClass('leadgen-noscroll');
    ...
    function leadShowPopupNewbuilder(campaignShow) {
      ...
      `;
          ...
          if (currentLayout.includes('Inline')) {
            ...
            if ($content.length) {
              ...
              const $posEnd = $child.eq($child.length - 1);
      ...
      `);
        ...
        jQuery('body').on('click', '.js-popup-other-submit', function() {
          ...
          jQuery('body').removeClass('leadgen-noscroll');
