              ...
              <form class="lead-modal__form">
                ...
                <div class="lead-modal__checkbox-wrapper">
                  ...
                  <label for="checkbox" class="lead-modal__checkbox__label">
                    ${popUpTermAgreeText} <span style="color: #2c87f3; font-weight: bold;"><a target="blank" href="${popUpTermURL || 'https://hellobacsi.com/chinh-sach'}" style="text-decoration: none;" rel="noopener noreferrer">${popUpTermText}</a></span>
                  </label>
                </div>
      ...
      try {
        ...
        listBlockAdded.forEach((b) => {
          if (b.name == 'TitleBlock') {
            listFieldAddedHTML += `<h2 class="lead-modal__title ${'le-text-align-' + _.get(b.data, 'align')}">${b.data.value}</h2>`;
          }
          if (b.name == 'SubtitleBlock') {
            listFieldAddedHTML += `
        <p class="lead-modal__description ${'le-text-align-' + _.get(b.data, 'align')}">${b.data.value}</p>
        `;
          }
          if (b.name == 'TextBlock') {
            listFieldAddedHTML += `
          ...
          if (!_.get(actionBlocks, 'submitBlock.isHide')) {
            submitHTML = `
              <div class="lead-modal__checkbox-wrapper">
                        ...
                        <label for="checkbox" class="lead-modal__checkbox__label">
                          ${popUpTermAgreeText} <span style="color: #2c87f3; font-weight: bold;"><a target="blank" href="${popUpTermURL || 'https://hellobacsi.com/chinh-sach'}" rel="noopener noreferrer" style="text-decoration: none;">${popUpTermText}</a></span>
                        </label>
                      </div>
              <button id="lead-submit" type="submit" class="lead-modal__btn"> ${popUpSubmitText}</button>
              `;
            ...
            <div class="lead-modal__body le-newbuilder-overlay">
              <form class="lead-modal__form ${popupID}">
                <div style="margin-bottom: 20px;">
                  <h2 class="lead-modal__title ${'le-text-align-' + _.get(textBlocks.titleBlock.data, 'align')}">${titleText}</h2>
                  <p class="lead-modal__description ${'le-text-align-' + _.get(textBlocks.titleBlock.data, 'align')}">${textBlocks.subtitleBlock.data.value}</p>
                </div>
